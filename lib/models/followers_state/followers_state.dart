...
class FollowersState with _$FollowersState {
  ...
  const factory FollowersState.userIsNotFollowed() =
      _FollowersStateUserIsNotFollowed;
  const factory FollowersState.determiningState() =
      _FollowersStateDeterminingState;
