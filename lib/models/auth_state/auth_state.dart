...
class AuthState with _$AuthState {
  ...
  const factory AuthState.accountExistsWithDifferentCredential() = _AuthStateAccountExistsWithDifferentCredential;
  const factory AuthState.credentailAlreadyInUse() = _AuthStateCredentailAlreadyInUse;
...
const firebaseAuthErrorCodes = {
  ...
  'account-exists-with-different-credential': AuthState.accountExistsWithDifferentCredential(),
